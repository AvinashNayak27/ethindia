    ...
    <div className="px-6 py-4">
      <div className="grid gap-4">
        <div className="flex items-center gap-3">
          ...
          <label htmlFor="upload" className="ml-auto cursor-pointer bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Select File
          </label>
          <input className="hidden" id="upload" type="file" onChange={handleFileChange} />
          <button onClick={verifyImage} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-4">
            Verify Image
          </button>
        </div>
